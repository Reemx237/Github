 ...
 */
var numLikes=500
print("The numLikes is var")
var numComments=1000
print("The numComments is var")
let yearCreated=2023
print("The yearCreated is constant")
let MonthCreated=2
print("The MonthCreated is constant")
let DayCreated=14
print("The DayCreated is constant")
/*:

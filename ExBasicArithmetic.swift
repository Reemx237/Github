...
if (area % 2 == 0){
    print("There is no space for storage item ")}
else{
    print("There is a space for storage item ")}
 ...
 */
let permeter = (2 * width)+(2 * height);
print("The permeter  is equal \(perimeter) !")
...
let integer = 100 ;
let integerDivisionResult = (integer/10)/3 ;
print("The result of divied of 10 and 3 from the integer \(integer) is equal \(integerDivisionResult) !")
...
print("The result of divied of 10 by 3 is equal \(divisionResult) !")
...
print("The diameter is equal \(diameter) !")
print("The diameter is equal \(circumference) !")
...
print("The reminder of divided 12 by 5 is equal \(integerConstant) !")
...
let even = 22 ;
let odd = 9 ;
let reminderOfEven = even % 2 ;
let reminderOfOdd = odd % 2 ;
var list1 = [Int]();
list1.append(reminderOfEven);
list1.append(reminderOfOdd);
for i in list1{
 if (i == 0 ){
    print("The reminder of the constant after divided it by 2 is \(i) so the constant is even number!")
 }
    else{ print("The reminder of the constant after divided it by 2 is \(i) so the constant is odd number!")}}